...
Base.prototype.attr = function(attr,value){
    //return this.elements[0][attr];  因为不支持自定义属性 舍弃
    for(var i = 0; i<this.elements.length; i++){
...
Base.prototype.next = function(){
     for(var i = 0; i<this.elements.length; i++){
           ...
           if(this.elements[i] == 'undefined') throw new Error('找不到下一个同级元素节点');
...
Base.prototype.prev = function(){
     for(var i = 0; i<this.elements.length; i++){
           ...
           if(this.elements[i] == 'undefined') throw new Error('找不到上一个同级元素节点');
...
Base.prototype.toggle = function(){
       for(var i = 0; i<this.elements.length; i++){
           ...
           })(this.elements[i],arguments); //闭包传参  
       }  
       return this;
};
...
Base.prototype.lock = function(){
     for(var i = 0; i<this.elements.length; i++){
            //alert(getScroll().top);
            fixedScroll.top = getScroll().top;  //变成全局，作为fixedScroll对象的静态属性
            fixedScroll.left = getScroll().left;//变成全局，作为fixedScroll对象的静态属性
            this.elements[i].style.display = 'block';
...
Base.prototype.resize = function(fn){
        for(var i = 0; i<this.elements.length; i++){
            ...
            addEvent(window,'resize',function(){
                ...
                if(element.offsetTop > getInner().heigth + getScroll().top - element.offsetHeight){
                    element.style.top = getInner().heigth + getScroll().top - element.offsetHeight + 'px';
