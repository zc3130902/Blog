...
Base.prototype.resize = function(fn){
        for(var i = 0; i<this.elements.length; i++){
            ...
            window.onresize = function(){//更改窗口大小 保证弹窗在页面上
                fn();
...
Base.prototype.drag = function(fn){
       for(var i = 0; i<this.elements.length; i++){
            this.elements[i].onmousedown = function(e){//点击需要划定区域为oLogin
                preDef(e); //取消默认行为 因为低版本火狐可能会有问题
                var e = getEvent(e);
                var _this = this; // oLogin
                var diffX = e.clientX - _this.offsetLeft;
                var diffY = e.clientY - _this.offsetTop;
                if(typeof _this.setCapture != 'undefined'){//解决低版本IE出框bug
                     _this.setCapture();
                };
                ...
                document.onmouseup = function(e){
                    ...
                    this.onmouseup = null;
                    if(typeof _this.releaseCapture != 'undefined'){//解决低版本IE出框bug
